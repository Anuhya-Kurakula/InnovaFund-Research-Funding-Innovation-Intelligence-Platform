# 🚀 Innovation Scoring Engine (Enterprise Intelligence Platform)
...
To pull live signals from teammates (& 3), **the only change required is setting environment variables**:
```env
SIGNAL_SOURCE=http
