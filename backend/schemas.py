...
# ==========================================
# Release: Grant Matching Schemas
# ==========================================
...
# ==========================================
# Release: Technology Intelligence Schemas (Deliverable)
# ==========================================
...
class TechnologyMaturityResponse(BaseModel):
    ...
    maturity_score: float # 0.0 to 100.0 (Supplies 15% weight to s scoring model)
...
# ==========================================
# Release: Patent Landscape, Innovation Scoring & Commercialization Schemas
# ==========================================
