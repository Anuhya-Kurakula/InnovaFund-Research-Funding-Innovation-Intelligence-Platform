...
## 4. Objectives
- **Release Objectives**: Establish project foundation, database schema (Relational PostgreSQL + Document MongoDB), FastAPI REST backend, React + Vite frontend, JWT authentication & RBAC, research profile management, multi-source publication/patent dataset services, Docker orchestration, and developer documentation.
