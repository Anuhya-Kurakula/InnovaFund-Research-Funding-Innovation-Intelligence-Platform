...
- **Release**: Foundation, Auth, Profiles, OpenAlex Publications, Patents, Pytest suite.
- **Release**: Funding Discovery Module, Recommendation Scoring, Research Trend Intelligence, Interactive Application Portal, Global Theme Switcher Engine.
